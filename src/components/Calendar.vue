<template>
  <div class="comp-full-calendar">
    ...
    >
      <v-slot name="fc-header-left"> </v-slot>

      <v-slot name="fc-header-right"> </v-slot>
    </fc-header>
    <!-- body display date day and events -->
    <div class="full-calendar-body">
      <div class="weeks">
        <strong class="week" :key="dayIndex" v-for="dayIndex in 7">
          {{ localeWeekDay(firstDay, locale) }}
        </strong>
      </div>
          ...
          <div class="events-week" v-for="week in currentDates" :key="week">
            ...
            >
              ...
              <div class="event-box">
                ...
                >
                  <template v-v-slot="p">
                    <v-slot name="fc-event-card" :event="p.event"></v-slot>
                  </template>
                </reminder-card>
                <p
      ...
      for (let perWeek = 0; perWeek < 6; perWeek++) {
        ...
        for (let perDay = 0; perDay < 7; perDay++) {
          week.push({
            ...
            events: this.v-slotEvents(monthViewStartDate)
          })
